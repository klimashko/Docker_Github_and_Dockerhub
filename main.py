...
start_dialog = Dialog(
    Window(
        Const('<b>Вы находитесь в первом окне 1-го диалога</b>\n'),
    ...
    Window(
        Const('<b>Вы находитесь во втором окне 1-го диалога</b>\n'),
        Const('Вы можете переключаться между окнами текущего диалога, '
              'или перейти в новый 👇'),
        Row(
    ...
    Window(
        Const('<b>Вы находитесь в третьем окне 1-го диалога</b>\n'),
        Const('Вы можете переключаться между окнами текущего диалога, '
              'или перейти в новый 👇'),
        Row(
            Button(Const('1️⃣'), id='w_first', on_click=switch_to_first_one),
